import type { ChampionTag, CompositionRules, MatchupData, PlayerChampionStats, PlayerProfile } from "@sparta/core";

export const mockChampionStats: PlayerChampionStats[] = [
  {
    championId: 61,
...
export const mockChampionTags: ChampionTag[] = [
  {
    championId: 61,
    championName: "Orianna",
    roles: ["MID"],
...
export const mockMatchups: MatchupData[] = [{ championId: 61, enemyChampionId: 157, role: "MID", score: 58, sampleSize: 100 }];
