...
5. **Download de skin corrigido** (`registerSkinDownloadHandler`, `main/index.ts`) — a CDN da Data Dragon (Akamai) responde 403 pra `fetch` sem header `User-Agent` (o processo main do Electron não manda um por padrão). Adicionado um UA de navegador. Validado de verdade via o bridge IPC real (baixou um JPEG de 158KB/1215x717 pro disco, sem 403).
